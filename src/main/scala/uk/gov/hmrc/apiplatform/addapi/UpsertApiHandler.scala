...
class UpsertApiHandler(override val apiGatewayClient: ApiGatewayClient,
  ...
  val AccessLogFormat: String =
    """{
      ...
      |"authorizer.applicationName": "$context.authorizer.applicationName",
      ...
      |"apiId": "$context.apiId",
      |"application.usagePlanId": "$context.authorizer.usagePlanId",
      |"application.usagePlanName": "$context.authorizer.usagePlanName"}""".stripMargin.replaceAll("[\n\r]","")
